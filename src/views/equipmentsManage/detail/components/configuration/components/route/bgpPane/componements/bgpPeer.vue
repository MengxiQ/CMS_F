...
<!--    </h5>-->
    ...
    <el-table :data="list">
      <el-table-column label="邻居地址" prop="peerAddr"></el-table-column>
      <el-table-column label="远程AS" prop="remoteAs"></el-table-column>
      <el-table-column label="本地接口" prop="localIfName"></el-table-column>
      <el-table-column label="ebgp最大跳数" prop="ebgpMaxHop"></el-table-column>
