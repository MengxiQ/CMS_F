...
import BgpPeer from '@/views/equipments/detail/components/bgpPane/componements/bgpPeer'
import { isArray } from '@/utils/isType'
import BgpNetwork from '@/views/equipments/detail/components/bgpPane/componements/bgpNetwork'
import BgpImport from '@/views/equipments/detail/components/bgpPane/componements/bgpImport'

export default {
  name: 'BgpPane',
  components: { BgpImport, BgpNetwork, BgpPeer },
  mixins: [baseMinxin],
  data() {
    return {
      bgpVrfs: [],
