...
import { getBgpImportProtocol, createBgpImportProtocol, deleteBgpImportProtocol } from '@/api/detail/bgp/bgp-base'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loadingInit = true
      getBgpImportProtocol(this.ip).then(res => {
        // console.log(res)
